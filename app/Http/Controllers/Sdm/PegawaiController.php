...
class PegawaiController extends Controller
{
    ...
    public function store(Request $request)
    {
        $dataValues = [
            ...
            'tanggal_lahir' => convertDmyToYmd($request->tanggal_lahir ?? '') ?: '0000-00-00',
            'golongan_upah' => $request->golongan_upah,
            'tmt_status_kepegawaian' => convertDmyToYmd($request->tmt_status_kepegawaian ?? '') ?: '0000-00-00',
            'tmt_pwtt' => convertDmyToYmd($request->tmt_pwtt ?? '') ?: '0000-00-00',
            'tmt_pwt' => convertDmyToYmd($request->tmt_pwt ?? '') ?: '0000-00-00',
            'masa_kerja' => $request->masa_kerja,
            'fungsi' => $request->fungsi,
            'id_unit' => $request->id_unit,
            'id_sub_fungsi' => $request->id_sub_fungsi,
            'tmt_jabatan' => convertDmyToYmd($request->tmt_jabatan ?? '') ?: '0000-00-00',
            'tmt_golongan_upah' => convertDmyToYmd($request->tmt_golongan_upah ?? '') ?: '0000-00-00',
            ...
            'masa_berlaku_str' => convertDmyToYmd($request->masa_berlaku_str ?? '') ?: '0000-00-00',
            'nomor_sip' => $request->nomor_sip,
            'masa_berlaku_sip' => convertDmyToYmd($request->masa_berlaku_sip ?? '') ?: '0000-00-00',
            'asuransi_profesi' => $request->asuransi_profesi,
            'nomor_polis' => $request->nomor_polis,
            'masa_berlaku_asuransi' => convertDmyToYmd($request->masa_berlaku_asuransi ?? '') ?: '0000-00-00',
            ...
            'tanggal_akhir_kontrak' => convertDmyToYmd($request->tanggal_akhir_kontrak ?? '') ?: '0000-00-00',
