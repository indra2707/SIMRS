...
$(document).ready(function () {
    ...
    $(document).click(function (e) {
        $("tr td .actions_wrapper .current_action").removeClass("active");
    });

    $("table").on("click", "tr td .actions_wrapper .current_action", function (e) {
        e.stopPropagation();
        $(this).parent().toggleClass("active");

        setTimeout(function () {
            $(".more_actions").toggleClass("active");
        }, 5);
    });
    ...
    //     $('.actions_wrapper, .more_actions').toggleClass('active');
    // });

    // $(".actions_wrapper .current_action").click(function (e) {
    //     e.stopPropagation();
    //     $(this).parent().toggleClass("active");
