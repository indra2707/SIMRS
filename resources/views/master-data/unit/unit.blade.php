...
@section('content')
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-sm-12 col-lg-12 col-xl-12">
                            <div class="table-responsive signal-table">
                                <table id="table_unit"  class="table table-hover" data-buttons-class="primary"
                                data-toggle="table">
    ...
    {{-- Modal Form Unit --}}
    <div class="modal fade" id="modal-unit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-wizard form-unit" novalidate="" autocomplete="off">
                        @csrf
                        {{-- Hidden Input --}}
                        <div class="mb-2 row">
                        ...
                        {{-- Nama --}}
                        <div class="mb-2 row">
                            <label class="col-sm-2 col-form-label" for="nama">Nama Unit</label>
                            <div class="col-sm-10">
...
@section('script')
    @include('master-data.unit.script')
@endsection
