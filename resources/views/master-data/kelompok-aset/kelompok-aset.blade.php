...
@section('content')
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <button class="btn btn-primary add-btn">
                            ...
                            <span> Tambah Kelompok Asset</span>
                        </button>
                        {{-- Table View --}}
                        <div class="col-sm-12 col-lg-12 col-xl-12">
                            <div class="table-responsive signal-table">
                                <table id="table_kelompok-asset"  class="table table-hover" data-buttons-class="primary"
                                data-toggle="table">
                                <thead class="text-bold text-white text-uppercase text-center">
                                        <tr>
                                            <th class="f-light">Kode</th>
                                            <th class="f-light">Keterangan</th>
                                            <th class="f-light">Jumlah Bulan</th>
    ...
    {{-- Modal Form Kelompok Asset --}}
    <div class="modal fade" id="modal-kelompok-asset" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-wizard form-kelompok-asset" novalidate="" autocomplete="off">
                        @csrf
                        {{-- Hidden Input --}}
                        <div class="mb-2 row">
                        ...
                        <div class="mb-2 row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control form-control" name="bulan" type="number" min="0"
...
@section('script')
    @include('master-data.kelompok-aset.script')
@endsection
