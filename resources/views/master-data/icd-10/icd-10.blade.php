...
@section('content')
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-sm-12 col-lg-12 col-xl-12">
                            <div class="table-responsive signal-table">
                                <table id="table_icd10" class="table table-hover" data-buttons-class="primary"
                                data-toggle="table">
                                <thead class="text-bold text-white text-uppercase text-center">
                                        <tr>
                                            <th class="f-light">Kode</th>
                                            <th class="f-light">Nama ICD 10</th>
    ...
    {{-- Modal Form --}}
    <div class="modal fade" id="modal-icd10" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-wizard form-icd10" novalidate="" autocomplete="off">
                        ...
                        {{-- Kode --}}
                        <div class="mb-2 row">
                            <label class="col-sm-2 col-form-label" for="kode">Kode ICD 10</label>
                            <div class="col-sm-10">
                        ...
                        {{-- Nama --}}
                        <div class="mb-2 row">
                            <label class="col-sm-2 col-form-label" for="nama">Nama ICD 10</label>
                            <div class="col-sm-10">
...
@section('script')
    @include('master-data.icd-10.script')
@endsection
