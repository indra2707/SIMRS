...
@section('content')
    ...
    {{-- Modal Form --}}
    <div class="modal fade" id="modal-spesialis" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-wizard form-spesialis" novalidate="" autocomplete="off">
                        @csrf
                        {{-- Hidden Input --}}
                        <div class="mb-2 row">
...
@section('script')
    @include('master-data.spesialis.script')
@endsection
