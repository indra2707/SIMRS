...
@section('content')
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-sm-12 col-lg-12 col-xl-12">
                            <div class="table-responsive signal-table">
                                <table id="table_customer"  class="table table-hover" data-buttons-class="primary"
                                data-toggle="table">
    ...
    {{-- Modal Form Lokasi --}}
    <div class="modal fade" id="modal-customer" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-wizard form-customer" novalidate="" autocomplete="off">
                        @csrf
                        {{-- Hidden Input --}}
                        <div class="mb-2 row">
...
@section('script')
    @include('master-data.customer.script')
@endsection
