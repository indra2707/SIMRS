...
@section('breadcrumb-title')
    <h3>Sapphire Access Door Management</h3>
@endsection
...
@section('content')
    <div class="container-fluid">
                        ...
                        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                            ...
                            <div class="col-sm-12 col-lg-12 col-xl-12">
                                <div class="table-responsive signal-table">
                                    <table id="table_sapphire" class="table table-hover" data-buttons-class="primary"
                                        data-toggle="table">
        ...
        {{-- Modal Form --}}
        <div class="modal fade" id="modal-sapphire" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="row g-2 form-sapphire" enctype="multipart/form-data" autocomplete="off">
                            @csrf
