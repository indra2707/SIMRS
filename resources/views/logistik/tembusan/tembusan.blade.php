...
@section('content')
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-sm-12 col-lg-12 col-xl-12">
                            <div class="table-responsive signal-table">
                                <table id="table_tembusan" class="table table-hover" data-buttons-class="primary"
                                    data-toggle="table">
    ...
    {{-- Modal Form Tembusan --}}
    <div class="modal fade" id="modal-tembusan" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="row g-2 form-tembusan" autocomplete="off">
                        @csrf
...
@section('script')
    @include('logistik.tembusan.script')
@endsection
