    ...
    <link rel="stylesheet" href="{{ asset('assets/bootstrap-table/dist/extensions/fixed-columns/bootstrap-table-fixed-columns.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/bootstrap-table/dist/extensions/filter-control/bootstrap-table-filter-control.css') }}">
