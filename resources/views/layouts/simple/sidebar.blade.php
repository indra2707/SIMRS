        ...
        <nav class="sidebar-main">
            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    {{-- Master Data --}}
                    @if(
                            in_array('Asset & Inventaris', $aksesMenu) || in_array('Lokasi', $aksesMenu) || in_array('Kondisi Asset', $aksesMenu)
                            || in_array('Kelompok Asset', $aksesMenu) || in_array('Vendor', $aksesMenu)
                        )
