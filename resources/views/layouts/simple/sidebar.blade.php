<div class="sidebar-wrapper" sidebar-layout="stroke-svg">
    <div>
        <div class="logo-wrapper">
            <a href="{{ route('home') }}">
                <img class="img-fluid for-light" src="{{ asset('assets/images/ihc/logo-text.png') }}" alt="">
                <img class="img-fluid for-dark" src="{{ asset('assets/images/ihc/logo-text.png') }}" alt="">
            </a>
            <div class="back-btn">
                ...
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    @if (in_array('User', $aksesMenu) || in_array('Roll', $aksesMenu))
                        <li class="sidebar-list"><i class="fa fa-thumb-tack"> </i>
                            ...
                            <ul class="sidebar-submenu">
                                @if (in_array('User', $aksesMenu))
                                    <li><a href="{{ route('user.user') }}">User</a></li>
                                @endif
                                @if (in_array('Roll', $aksesMenu))
                                    <li><a href="{{ route('user.roll') }}">Role</a></li>
                                @endif
                            </ul>
                        </li>
                    @endif
                    ...
                    {{-- Master Data --}}
                    @if (
                            in_array('Asset & Inventaris', $aksesMenu) ||
                            in_array('Lokasi', $aksesMenu) ||
                            ...
                            in_array('Unit', $aksesMenu) ||
                            in_array('Jenis Kontrak', $aksesMenu)
                        )
                        ...
                        <li class="sidebar-list"><i class="fa fa-thumb-tack"></i>
                            ...
                            <ul class="sidebar-submenu">
                                ...
                                @endif
                                @if (in_array('Lokasi', $aksesMenu))
                                    <li><a href="{{ route('master-data.lokasi') }}">Lokasi</a></li>
                                @endif
                                @if (in_array('Kondisi Asset', $aksesMenu))
                                    <li><a href="{{ route('master-data.kondisi-aset') }}">Kondisi Asset</a></li>
                                @endif
                                @if (in_array('Kelompok Asset', $aksesMenu))
                                    <li><a href="{{ route('master-data.kelompok-aset') }}">Kelompok Asset</a></li>
                                @endif
                                ...
                                @endif
                                @if (in_array('Bank', $aksesMenu))
                                    <li><a href="{{ route('master-data.bank') }}">Bank</a></li>
                                @endif
                                @if (in_array('Fungsi', $aksesMenu))
                                    <li><a href="{{ route('master-data.fungsi') }}">Fungsi</a></li>
                                @endif
                                @if (in_array('Unit', $aksesMenu))
                                    <li><a href="{{ route('master-data.unit') }}">Unit</a></li>
                                @endif
                                @if (in_array('SK Struktur', $aksesMenu))
                                    <li><a href="{{ route('master-data.sk-struktur') }}">SK Struktur</a></li>
                                @endif
                                @if (in_array('Jenis Kontrak', $aksesMenu))
                                    <li><a href="{{ route('master-data.jenis-kontrak') }}">Jenis Kontrak</a></li>
                                @endif
                            </ul>
                        </li>
                    @endif
                    ...
                    {{-- mutasi --}}
                    @if (in_array('Mutasi Asset & Inventaris', $aksesMenu))
                        <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                class="sidebar-link sidebar-title link-nav" href="{{ route('master-data.mutasi') }}">
                                <svg class="stroke-icon">
                    ...
                    @if (in_array('Kalibrasi Alat Kesehatan', $aksesMenu))
                        <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                class="sidebar-link sidebar-title link-nav" href="{{ route('master-data.kalibrasi') }}">
                                <svg class="stroke-icon">
                                    <use href="{{ asset('assets/svg/icon-sprite.svg#fill-others') }}"></use>
                                </svg>
                                <svg class="fill-icon">
                                    <use href="#"></use>
                                </svg><span>kalibrasi</span></a>
                            </a>
                        </li>
                    @endif
                    ...
                    <li class="sidebar-list"><i class="fa fa-thumb-tack"></i>
                        ...
                        <ul class="sidebar-submenu">
                            ...
                            <li><a href="{{ route('surat.aprovalMemorandum')}}">Approval Memorandum</a></li>
                        </ul>
                    </li>
                    ...
                    @if (Session::get('username') == 'superadmin')
                                    ...
                                    <ul class="sidebar-submenu">
                                        <li><a class="submenu-title" href="#">Form Controls<span class="sub-arrow"><i
                                            ...
                                            <ul class="nav-sub-childmenu submenu-content">
                                                ...
                                                <li><a href="{{ route('radio-checkbox-control') }}">Checkbox & Radio</a>
                                                </li>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                        ...
                                        <svg class="stroke-icon">
                                            <use href="{{ asset('assets/svg/icon-sprite.svg#stroke-starter-kit') }}">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col mega-box">
                                                    <div class="link-section">
                                                        ...
                                                        <ul class="submenu-content opensubmegamenu">
                                                            <li><a href="{{ route('comingsoon') }}">Coming Simple</a>
                                                            </li>
                                                            <li><a href="{{ route('comingsoon-bg-video') }}">Coming with
                                                                    Bg
                                                                    video</a></li>
                                                ...
                                                <div class="col mega-box">
                                                    <div class="link-section">
                                                        ...
                                                        <ul class="submenu-content opensubmegamenu">
                                                            <li><a href="{{ route('basic-template') }}">Basic Email</a>
                                                            </li>
                                                            <li><a href="{{ route('email-header') }}">Basic With
                                                                    Header</a>
                                                            </li>
                                                            <li><a href="{{ route('template-email') }}">Ecomerce
                                                                    Template</a>
                                                            </li>
                                ...
                                <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title"
                                        href="#">
                                        <svg class="stroke-icon">
                                            <use href="{{ asset('assets/svg/icon-sprite.svg#stroke-job-search') }}">
                                            </use>
                                        </svg>
                                        <svg class="fill-icon">
