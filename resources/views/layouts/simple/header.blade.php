    ...
    <div class="header-wrapper row m-0">
        ...
        <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="{{ route('home') }}">
                    <img class="img-fluid" src="{{ asset('assets/images/ihc/logo-text.png') }}" alt="">
                </a></div>
        ...
        <div class="left-header col-xxl-5 col-xl-6 col-lg-5 col-md-4 col-sm-3 p-0">
            <div class="notification-slider slick-initialized slick-slider slick-vertical">
                <h5 class="mb-0 f-w-400">
                    <span><b>HACIS - RSOJ PERTAMINA ROYAL BIRINGKANAYA</b></span>
            ...
            <ul class="nav-menus">
                ...
                <li class="profile-nav onhover-dropdown pe-0 py-0">
                    ...
                    <ul class="profile-dropdown onhover-show-div">
                        ...
                        <li><a href="{{ route('master-data.dokumen') }}"><i data-feather="file-text"></i><span>Dokumen</span></a></li>
