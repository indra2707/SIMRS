...
Route::group(['middleware' => 'loggedin'], function () {
    ...
    Route::prefix('master-data')->group(function () {
        ...
        Route::get('/dokumen-lainnya/jenis-terpakai/{id_pegawai}', [DokumenLainnyaController::class, 'jenisTerpakai'])->name('master-data.dokumen-lainnya.jenis-terpakai');
    });
    ...
    Route::prefix('global-controller')->group(function () {
        ...
        // Pegawai
        Route::get('/get-select-pegawai', [GlobalController::class, 'optionsSelectPegawai'])->name('get-select-pegawai');
        // kondisi aset
